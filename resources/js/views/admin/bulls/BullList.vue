<template>
    <div class="container-fluid">
        <breadcrumb :options="['Bull List']">
            <button class="btn btn-primary"  @click="addListDataModal()">Add Bull </button>
        </breadcrumb>
        ...
        <add-edit-bullListData @changeStatus="changeStatus" v-if="loading"/>
